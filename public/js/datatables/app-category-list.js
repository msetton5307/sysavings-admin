$(function () {
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (datas, type, full, meta) {
              if (full["image"]) {
                return (
                  '<img src="/uploads/category/' +
                  full["image"] +
                  '" alt="logo" height="32" width="32">'
                );
              } else {
                return '<img src="../../uploads/noImage.png" alt="logo image"  height="48" width="48" />';
              }
            },
          },
          {
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                "/category/edit/" +
                full["_id"] +
                '" class="dropdown-item delete-record deleteFAQ">' +
  ...
  $(document).on("click", ".add-new", function () {
    window.location.href = `${window.location.protocol}//${window.location.host}/category/add`;
  });
