$(function () {
  ...
  var dtUserTable = $('.user-list-table'),
    ...
    statusObj = {
      ...
      'Unblock': { title: 'Unblock', class: 'badge-light-success' },
  ...
  $(document).on('click', '.add-new', function () {
    window.location.href = `${window.location.protocol}//${window.location.host}/user/add`;
});
  ...
  $(document).on('click', '.edit-user-modal', function () {
    ...
    let image = $(this).data('profile_image');
    let phone = $(this).data('phone');
    console.log($(this),"fff");
    $('#user-edit-name').val(name);
    $('#user-edit-email').val(email);
    $('#user-edit-email').val(email);
    $('#user-edit-phone').val(phone)
    $('#user-edit-id').val(elemID);
    if (image) {
      $('.imageHref').attr('href', `/uploads/user/profile_pic/${image}`);
      $('#userImg').attr('src', `/uploads/user/profile_pic/${image}`);
    } else {
      $('#userImg').attr('src', `/uploads/noImage.png`);
    }
