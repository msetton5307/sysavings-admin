    ...
    if (suspendUser) {
      suspendUser.onclick = function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            window.location.href = `${location.protocol}//${window.location.host}/service-provider/delete/${elemID}`;
    ...
    if (userPasswordReset) {
      userPasswordReset.onclick = function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            window.location.href = `${location.protocol}//${window.location.host}/service-provider/reset-password/${elemID}`;
          } 
        });
      };
    }
