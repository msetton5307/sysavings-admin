...
```
cd existing_repo
git remote add origin https://gitlab.webskitters.com/node/sysaving.git
git branch -M dev
...
- [ ] [Set up project integrations](https://gitlab.webskitters.com/node/sysaving/-/settings/integrations)
